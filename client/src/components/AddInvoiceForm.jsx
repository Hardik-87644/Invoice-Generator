...
const AddInvoiceForm = ({ onInvoiceSaved }) => {
  const [formData, setFormData] = useState({
    customerName: "",
    customerEmail: "",
    products: [{ name: "", quantity: "", price: "", disabled: false }], // Add 'disabled' property
    tax: "",
  });
  ...
  const addProductRow = () => {
    ...
    setFormData({
      ...
      products: [
        ...updatedProducts,
        { name: "", quantity: "", price: "", disabled: false },
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <h3 className=" font-medium text-gray-800 mb-4">Products <span className="text-red-600" >*</span></h3>
